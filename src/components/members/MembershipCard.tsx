...
export function MembershipCard({ member, viewMode = "digital" }: MembershipCardProps) {
      ...
      <div className="flex flex-col md:flex-row gap-8 justify-center items-center w-full max-w-5xl select-none print:flex-row print:gap-4 print:justify-center">
        ...
        <div className="relative w-[460px] h-[280px] rounded-2xl p-5 bg-gradient-to-b from-[#FCFAF6] to-[#F5F2E9] border-2 border-[#C5A059] shadow-elegant flex flex-col justify-between overflow-hidden print:shadow-none print:border-[#C5A059]/80">
          ...
          <div className="relative z-10 flex justify-between items-end border-t border-[#C5A059]/20 pt-2 text-[7px] text-muted-foreground">
            <p className="uppercase tracking-[0.1em] text-[#C5A059] font-semibold">T.·. F.·. A.·.</p>
        ...
        <div className="relative w-[460px] h-[280px] rounded-2xl p-5 bg-gradient-to-b from-[#FCFAF6] to-[#F5F2E9] border-2 border-[#C5A059] shadow-elegant flex flex-col justify-between overflow-hidden print:shadow-none print:border-[#C5A059]/80">
          ...
          <div className="relative z-10 flex justify-between items-end border-t border-[#C5A059]/20 pt-2 text-[7px] text-muted-foreground">
            <p>G.·. A.·. D.·. U.·.</p>
            <p className="font-semibold text-[#C5A059]">Filiada ao G.O.M.B.</p>
          </div>
        </div>
      </div>
    );
  ...
  /* DIGITAL MODE: VERTICAL FLIPPING CARD */
  return (
    <div className="flex flex-col items-center select-none">
      {/* 3D Card Container */}
      <div
        className="w-full max-w-[340px] h-[530px] perspective-1000 cursor-pointer"
        ...
        >
          ...
          <div className="absolute inset-0 w-full h-full rounded-2xl p-5 bg-gradient-to-b from-[#FCFAF6] to-[#F5F2E9] border-2 border-[#C5A059] shadow-elegant backface-hidden flex flex-col justify-between overflow-hidden">
            ...
            <div className="relative z-10 flex flex-col items-center my-auto">
              ...
              {/* Card Details grid */}
              <div className="w-full grid grid-cols-2 gap-3 border-t border-b border-[#C5A059]/30 py-3.5 px-2 bg-[#F3EFE4]/35 rounded-xl text-left">
                <div>
            ...
            {/* Bottom Bar / Footer */}
            <div className="relative z-10 flex justify-between items-end border-t border-[#C5A059]/40 pt-2 text-muted-foreground text-[8px]">
              <div>
                <p className="uppercase tracking-[0.1em] text-[#C5A059] font-bold">G.·. A.·. D.·. U.·.</p>
                <p className="mt-0.5 text-[7px]">Filiada ao G.O.M.B.</p>
              </div>
              <p className="text-right text-[7px] uppercase tracking-[0.05em] text-[#C5A059]/60">
                Girar carteirinha
              </p>
            </div>
          </div>
          ...
          <div className="absolute inset-0 w-full h-full rounded-2xl p-5 bg-gradient-to-b from-[#FCFAF6] to-[#F5F2E9] border-2 border-[#C5A059] shadow-elegant backface-hidden rotate-y-180 flex flex-col justify-between overflow-hidden">
            ...
            {/* Top Bar / Header */}
            <div className="relative z-10 flex items-center gap-2.5 border-b border-[#C5A059]/40 pb-2">
              <img src={logoUrl} alt="Brasão" className="h-9 w-9 drop-shadow-[0_0_4px_rgba(197,160,89,0.3)]" />
              <div>
                <h2 className="font-display text-xs font-bold text-[#0C1938] leading-tight">União Fraternal Nº 1</h2>
                <p className="text-[7px] uppercase tracking-[0.05em] text-gold/80">Validação Cadastral</p>
              </div>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-center my-auto">
              ...
              <p className="text-muted-foreground text-[8px] text-center max-w-[210px] leading-normal">
            ...
            {/* Bottom Bar / Footer */}
            <div className="relative z-10 flex justify-between items-end text-[7px] text-muted-foreground">
      ...
      <p className="text-muted-foreground text-[10px] mt-3 italic">
